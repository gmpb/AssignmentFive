...
public class AssignmentFour {
    ...
    public void compileDictionary() {
        ...
        try {
            ...
            while (input.hasNext()) {
                ...
                dictionary[next.charAt(0) - 'a'].insert(next);
            } // while
        ...
        try {
            ...
            while (input.hasNext()) {
                ...
                for (int i = 0; i < lines.length; i++) {
                    ...
                    if (!s.isEmpty()) {
                        wordToBeSearched = s;
                        if (dictionary[wordToBeSearched.charAt(0) - 97].search(wordToBeSearched, count)) {
                            wordsFound++;
                            compsFound += count[0];
                        } // if 
                        else {
    ...
    for (int i = 0; i < x.dictionary.length; i++)
       x.dictionary[i] = new BinarySearchTree<String>(); 
